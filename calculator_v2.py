...
btn_0 = Button(root, text='0', padx=88, pady=20, fg='white', bg='gray',  command=lambda: calc_click(0))
btn_dot = Button(root, text='.', padx=41, pady=20, fg='white', bg='gray',  command=lambda: calc_click('.'))

btn_add_sign = Button(root, text='+', padx=45, pady=20, fg='black', bg='lightblue', command=lambda: calc_click('+'))
...
btn_equal_sign = Button(root, text='=', padx=44, pady=52, bg='lightgreen', command=calc)
...
btn_equal_sign.grid(row=4, column=3, rowspan=2)

btn_add_sign.grid(row=3, column=3)
